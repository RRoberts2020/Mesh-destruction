...
public class Cutter : MonoBehaviour
{
    ...
    public static void Cut(GameObject _originalGameObject, Vector3 _contactPoint, Vector3 _direction, Material _cutMaterial = null, bool fill = true, bool _addRigidbody = false)
    {
        ...
        for (int i = 0; i < originalMesh.subMeshCount; i++)
        {
            ...
            //MeshTriangle currentTriangle = GetTriangles(triangleIndexA, triangleIndexB, triangleIndexC, i);

            //bool triangleALeftSide = plane.GetSide(originalMesh.vertices[triangleIndexA]);
            //bool triangleBLeftSide = plane.GetSide(originalMesh.vertices[triangleIndexA]);
            //bool triangleCLeftSide = plane.GetSide(originalMesh.vertices[triangleIndexA]);
            ...
            //else
            {
                //CutTrigangle(plane, currentTriangle, triangleALeftSide, triangleBLeftSide, triangleCLeftSide, leftMesh, rightMesh, addedVertices);
            }
        }
    }
